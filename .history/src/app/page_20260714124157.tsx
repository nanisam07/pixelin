...
export default function Home() {
  ...
  const languageConfig: Record<string, { code: string; label: string; placeholder: string; voiceCode: string; defaultGreeting: string }> = {
    ...
    hi: {
      code: "hi-IN",
      label: "हिन्दी",
      placeholder: "फसलों, बीमारियों के بارے में पूछें...",
      voiceCode: "hi-IN",
    ...
    ml: {
      ...
      voiceCode: "ml-IN",
      defaultGreeting: "ഞാൻ നിങ്ങളെ എങ്ങനെ സഹായിക്കണം?"
    }
  };
  ...
  // Static translations dictionary placeholder to maintain backward safety
  const translations = {
    te: { placeholder: "మీ పంట గురించి అడగండి..." },
    hi: { placeholder: "अपनी फसल के बारे में पूछें..." },
    en: { placeholder: "Ask anything about your crop..." },
    kn: { placeholder: "ನಿಮ್ಮ ಬೆಳೆ ಬಗ್ಗೆ ಕೇಳಿ..." },
    ml: { placeholder: "നിങ്ങളുടെ വിളയെക്കുറിച്ച് ചോദിക്കൂ..." }
  };
          ...
          <div className="flex justify-center mb-12 reveal">
            <div className="bg-gray-200/60 p-1.5 rounded-2xl flex gap-2 w-full max-w-lg shadow-inner">
              {Object.keys(cropProducts).map((cropName) => (
                <button
                  key={cropName}
                  onClick={() => setActiveTab(cropName as "paddy" | "cotton" | "vegetables")}
