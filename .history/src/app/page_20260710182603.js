        ...
        >
          <div>
            ...
            <div className="flex flex-col gap-5 text-lg font-medium">
              ...
              <a 
              href="/scanner"              onClick={() => setIsMobileMenuOpen(false)}
              >
    Scan Your Crop
      ...
      <section id="hero" className="relative h-screen overflow-hidden">
        ...
        <div className="relative z-10 h-full w-full max-w-6xl mx-auto px-6 md:px-12 flex flex-col justify-center items-center text-center text-white select-none">
          ...
          <div className="animate-fade-up delay-3 flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
            <Link
              href="/scanner"
              className="px-8 py-3.5 bg-secondary hover:bg-secondary-light text-white font-label font-bold tracking-wider rounded-xl transition-all duration-300 hover:scale-[1.03] shadow-lg shadow-secondary-dark/30 text-center flex items-center justify-center gap-2"
            >
              📸 Scan Your Crop
            </Link>
            <a
