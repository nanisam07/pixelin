...
const startVoice = () => {
  ...
  kn: {
    placeholder:
      "ನಿಮ್ಮ ಬೆಳೆ ಬಗ್ಗೆ ಕೇಳಿ..."
  },

  ml: {
    placeholder:
      "നിങ്ങളുടെ വിളയെക്കുറിച്ച് ചോദിക്കൂ..."
  }
};
  ...
  📸 Scan Your Crop
      ...
      <section id="hero" className="relative h-screen overflow-hidden">
        ...
        <div className="relative z-10 h-full w-full max-w-6xl mx-auto px-6 md:px-12 flex flex-col justify-center items-center text-center text-white select-none">
          ...
          <div className="animate-fade-up delay-3 w-full max-w-3xl mx-auto">

  <div className="bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl p-2 flex items-center">
<div className="flex flex-wrap gap-3 mb-5">
  ...
  {[
    ...
    <input
      type="text"
      placeholder="Search diseases, products or ask anything..."
      value={searchQuery}
      onChange={(e) =>
